...
- **Session ID**: Automatically generated by the MCP client (Claude Desktop)
...
**Important**: Sessions are NOT automatically persisted when you close Claude Desktop or restart the MCP server.
...
- **Always export** your accounts before closing Claude Desktop
